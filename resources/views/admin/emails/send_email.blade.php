          ...
          <form action="{{ route('admin.email.post') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="form-control-label" for="input-small">Receiver Name</label>
                  ...
                  <input id="input-small" name="name" value="{{ old('name') }}" class="form-control form-control-sm" placeholder="name" type="text">
              ...
              <div class="form-group">
                <label class="form-control-label" for="input-small">Subject</label>
                <input id="input-small" name="subject" value="{{ old('subject') }}" class="form-control form-control-sm" placeholder="subject" type="text">

              </div>
              <div class="form-group">
                <label class="form-control-label" for="input-small">Message</label>
                <textarea id="summary-ckeditor" name="message" class="form-control form-control-sm" placeholder="message" >{{ old('message') }}
                </textarea>
              </div>
