...
<body style="padding:0; margin:0; box-sizing: border-box; -webkit-box-sizing: border-box; font-family: arial; font-size: 15px;    line-height: 24px;">
 ...
 ">
                Contact request form received.

                </b>
                <table cellpedding="0" cellspacing="0" style="margin: 0 0 15px; width: 80%;padding-top: 25px">
                    <tr>
                        <td>
                            <p style="margin: 0 0 5px;">Category </p>
                        </td>
                        <td>
                            <p style="margin: 0 0 5px;">: </p>
                        </td>
                        <td>
                            <p style="margin: 0 0 5px;    padding-left: 15px;"><?php echo ucfirst($data['category']); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p style="margin: 0 0 5px;">Price Limit </p>
                        </td>
                        <td>
                            <p style="margin: 0 0 5px;">: </p>
                        </td>
                        <td>
                            <p style="margin: 0 0 5px;    padding-left: 15px;"><?php echo $data['max']; ?></p>
                        </td>
                    </tr>
                    <!-- <tr>
                        <td>
                            <p style="margin: 0 0 5px;">Max Price </p>
                        </td>
                        <td>
                            <p style="margin: 0 0 5px;">: </p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <p style="margin: 0 0 5px;    padding-left: 15px;"><?php echo ucfirst($data['message']); ?></p>
                        </td>
                    </tr>
