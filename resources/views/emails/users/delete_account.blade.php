   ...
   <table cellpedding="0" celspacing="0" style="max-width: 620px; width:100%; margin: auto; border: 1px solid #ececec;">
       <tr>
           ...
           <div style="text-align: center;padding: 20px 0; ">
            ...
            <p style="margin-bottom: 20px;text-align:center;"><b style="font-size:16px;"> Sorry To See You Go 😢
                ...
                You have successfully deleted your account from Matutto.com 🗑️       We are sad to see you go, but you’re always welcome back 🤗
             </p>
                <p style="margin: 0;margin-bottom: 20px;">
                This email confirms all your data will be permanently deleted from our database within 24 hours.
      </p>
