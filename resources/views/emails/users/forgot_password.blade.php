...
<head>
	...
	body {
		background: white;
		color: #393939;
        padding:0; margin:0; box-sizing: border-box; -webkit-box-sizing: border-box; f
        ont-family: arial; font-size: 15px;    line-height: 24px;
	}
   ...
   <table cellpedding="0" celspacing="0" style="max-width: 620px; width:100%; margin: auto; border: 1px solid #ececec;">
       <tr>
           ...
           <div style="text-align: center;padding: 20px 0;" >
            ...
            <p style="margin-bottom: 20px;text-align:center;"><b style="font-size:16px;"> Complete Your Password Reset ⬇️  
</b> </p>
                <h6 style="margin: 0;font-size: 16px;margin-bottom: 20px;">Hi {{ $user->name }},</h6>
               
                <p style="margin: 0;margin-bottom: 20px;"> You have requested to reset your password on Matutto. You can do so by clicking the button below.
</p>
                <!-- <p> <a href="{{ config('variable.SERVER_URL') }}/reset-password/{{ $user->forgot_password_token}}" style="color: #90cbf5;">Reset Password</a></p> -->

                <p style="text-align:center">
                                                        
                                                        <a href="{{ config('variable.SERVER_URL') }}/reset-password/{{ $user->forgot_password_token}}" style="background-color: #f8b739;
                    border: none;
                    color: white;
                    padding: 7px 20px;
                    text-align: center;
                    ...
                    font-size: 16px;
                    cursor: pointer;
                    border-radius: 8px;margin-bottom: 20px;">Reset Password</a>                                  
                ...
                <p style="margin: 0;">Please note this link expires in 24 hours from receiving this email. If you wish to reset your password after that you must initiate the process again.
 </p>
